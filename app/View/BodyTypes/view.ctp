...
<h2><?php echo __('Body Type'); ?></h2>
	<dl>
		...
		<dd>
			<?php echo h($bodyType['BodyType']['description']); ?>
			&nbsp;
		</dd>
		<dt><?php echo __('Id'); ?></dt>
		<dd>
			<?php echo h($bodyType['BodyType']['id']); ?>
			&nbsp;
		</dd>
	</dl>
</div>
<div class="actions">
	...
	<ul>
		...
		<li><?php echo $this->Form->postLink(__('Delete Body Type'), array('action' => 'delete', $bodyType['BodyType']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $bodyType['BodyType']['id']))); ?> </li>
...
<div class="related">
	...
	<?php foreach ($bodyType['User'] as $user): ?>
		<tr>
