<div class="bodyTypes index">
	...
	<tr>
		...
		<td><?php echo h($bodyType['BodyType']['description']); ?>&nbsp;</td>
		<td><?php echo h($bodyType['BodyType']['id']); ?>&nbsp;</td>
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $bodyType['BodyType']['id']), array('confirm' => __('Are you sure you want to delete # %s?', $bodyType['BodyType']['id']))); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</tbody>
